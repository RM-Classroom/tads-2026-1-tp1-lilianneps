...
Mostrar o frontend com o layout AlugaFacil.

Passar pelas telas:

- Tela inicial com a logo.
- Painel principal com cards de totais.
- Tela de clientes com filtros por nome e CPF.
- Tela de veiculos com filtros por modelo e placa.
- Tela de alugueis com cadastro, consulta, edicao, exclusao e filtros.

Demonstrar um cadastro simples abrindo o modal, e depois consultar ou editar um registro pelo modal.
